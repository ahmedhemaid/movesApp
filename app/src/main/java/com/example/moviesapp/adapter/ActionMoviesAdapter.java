...
public class  ActionMoviesAdapter extends RecyclerView.Adapter<ActionMoviesAdapter.ViewHolder> {
    ...
    public ActionMoviesAdapter(List<Movie> movies) {
        mMovies = movies;
    }
    ...
    @NonNull
    @Override
    public ActionMoviesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final ActionMoviesAdapter.ViewHolder holder, final int position) {
