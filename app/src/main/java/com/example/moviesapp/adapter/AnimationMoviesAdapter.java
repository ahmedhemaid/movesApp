...
public class AnimationMoviesAdapter extends RecyclerView.Adapter<AnimationMoviesAdapter.ViewHolder> {
    public static List<Movie>favoriteArrayList=new ArrayList<>();
    ...
    public AnimationMoviesAdapter(List<Movie> movies) {
        mMovies = movies;
    }
    // Usually involves inflating a layout from XML and returning the holder
    @NonNull
    @Override
    public AnimationMoviesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final AnimationMoviesAdapter.ViewHolder holder, final int position) {
