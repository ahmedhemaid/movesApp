...
public class ComedyMoviesAdapter extends RecyclerView.Adapter<ComedyMoviesAdapter.ViewHolder> {
    ...
    public ComedyMoviesAdapter(List<Movie> movies) {
        mMovies = movies;
    }
    // Usually involves inflating a layout from XML and returning the holder
    @NonNull
    @Override
    public ComedyMoviesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final ComedyMoviesAdapter.ViewHolder holder, final int position) {
