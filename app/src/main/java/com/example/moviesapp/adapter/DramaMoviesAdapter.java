...
public class DramaMoviesAdapter extends RecyclerView.Adapter<DramaMoviesAdapter.ViewHolder> {
    ...
    public DramaMoviesAdapter(List<Movie> movies) {
        mMovies = movies;
    }
    // Usually involves inflating a layout from XML and returning the holder
    @NonNull
    @Override
    public DramaMoviesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final DramaMoviesAdapter.ViewHolder holder, final int position) {
