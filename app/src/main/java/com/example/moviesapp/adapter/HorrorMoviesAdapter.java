...
public class HorrorMoviesAdapter extends RecyclerView.Adapter<HorrorMoviesAdapter.ViewHolder> {
    ...
    public HorrorMoviesAdapter(List<Movie> movies) {
        mMovies = movies;
    }
    // Usually involves inflating a layout from XML and returning the holder
    @NonNull
    @Override
    public HorrorMoviesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final HorrorMoviesAdapter.ViewHolder holder, final int position) {
