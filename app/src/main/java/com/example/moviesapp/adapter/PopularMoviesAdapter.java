...
public class PopularMoviesAdapter extends RecyclerView.Adapter<PopularMoviesAdapter.ViewHolder> {
    public static List<Movie> favorite;
    ...
    public PopularMoviesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        //favorite shared preferences
        preferences= mContext.getSharedPreferences("favorite_ids", MODE_PRIVATE);
    ...
    @Override
    public void onBindViewHolder(@NonNull final PopularMoviesAdapter.ViewHolder holder, final int position) {
