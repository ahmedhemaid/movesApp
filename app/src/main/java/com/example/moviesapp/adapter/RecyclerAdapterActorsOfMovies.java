...
public class RecyclerAdapterActorsOfMovies extends RecyclerView.Adapter<RecyclerAdapterActorsOfMovies.ViewHolder> {
    TextView actorName;
    String mName="";
    ...
    public RecyclerAdapterActorsOfMovies(List<Actor> movies) {
        mActors = movies;
    }
    ...
    @NonNull
    @Override
    public RecyclerAdapterActorsOfMovies.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // Inflate the custom layout
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View rootView = inflater.inflate(R.layout.row_of_actors_of_movie, parent, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull final RecyclerAdapterActorsOfMovies.ViewHolder holder, final int position) {
