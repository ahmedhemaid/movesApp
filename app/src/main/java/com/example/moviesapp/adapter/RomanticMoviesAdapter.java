...
public class RomanticMoviesAdapter extends RecyclerView.Adapter<RomanticMoviesAdapter.ViewHolder> {
    ...
    public RomanticMoviesAdapter(List<Movie> movies) {
        mMovies = movies;
    }
    ...
    @NonNull
    @Override
    public RomanticMoviesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final RomanticMoviesAdapter.ViewHolder holder, final int position) {
