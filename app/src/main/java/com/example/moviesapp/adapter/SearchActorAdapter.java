...
public class SearchActorAdapter extends RecyclerView.Adapter<SearchActorAdapter.ViewHolder> {
    ...
    public SearchActorAdapter(List<Actor> movies) {
        mActors = movies;
    }
    ...
    @NonNull
    @Override
    public SearchActorAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final SearchActorAdapter.ViewHolder holder, final int position) {
