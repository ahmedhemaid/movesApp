...
public class SimilarMoviesAdapter extends RecyclerView.Adapter<SimilarMoviesAdapter.ViewHolder> {
    ...
    public SimilarMoviesAdapter(List<Movie> movies) {
        mMovies = movies;
    }
    ...
    @NonNull
    @Override
    public SimilarMoviesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final SimilarMoviesAdapter.ViewHolder holder, final int position) {
