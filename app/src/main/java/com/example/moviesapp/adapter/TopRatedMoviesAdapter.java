...
public class TopRatedMoviesAdapter extends RecyclerView.Adapter<TopRatedMoviesAdapter.ViewHolder> {
    ...
    public TopRatedMoviesAdapter(List<Movie> movies) {
        mMovies = movies;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final TopRatedMoviesAdapter.ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
